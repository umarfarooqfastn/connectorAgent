...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('connectorAgent.log'),
...
def main():
    ...
    if len(sys.argv) < 3:
        print("Usage: python connectorAgent.py <url> <platform_name> [description] [connector_group_id]")
        print("Example: python connectorAgent.py https://docs.example.com/api MyAPI 'API Description' optional_group_id")
        return
